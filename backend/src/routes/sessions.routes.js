...
import { openSessionSchema, closeSessionSchema } from "../validations/sessions.validation.js";
...
router.post("/:id/close", rbac("admin"), validate(closeSessionSchema), asyncHandler(controller.close));
